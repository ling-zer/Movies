...
import { IResponseData, IResponseError, IResponsePageData, ISearchCondtion } from "./CommonTypes";
...
export class MovieService {
    ...
    public static async getMovies(condition: ISearchCondtion): Promise<IResponsePageData<IMovie>> {
